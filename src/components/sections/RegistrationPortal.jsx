  ...
  return (
    <section id="register" className="relative py-24 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Terminal interface */}
        <ScrollMotion from="scale" blur distance={0}>
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          {[
            ...
            <ScrollMotion key={s.l} from="up" distance={80} delay={i * 0.08}>
              <div className="glass-panel border border-cyan/20 p-4 text-center h-full">
