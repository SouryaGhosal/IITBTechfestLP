...
export default function EventsGallery() {
  return (
    <section id="events" className="relative py-24 px-4">
      ...
      {/* Horizontal data-core gallery */}
      <div className="overflow-x-auto scrollbar-none -mx-4 px-4 pb-6">
        <div className="flex gap-5 w-max">
          {EVENTS.map((e, i) => (
            <article key={e.id}
              className="group relative w-[280px] sm:w-[320px] shrink-0 glass-panel border border-cyan/20 hover:border-cyan/60 transition-all duration-300 overflow-hidden">
              {/* Index marker */}
              ...
              <div className="p-5">
                ...
                {/* Specs - typewriter reveal on hover */}
