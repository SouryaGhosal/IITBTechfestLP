  ...
  return (
    <div className="relative min-h-screen bg-void text-data grid-bg">
      ...
      <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-0"
        style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(46,0,77,0.45), transparent 55%), radial-gradient(ellipse at 100% 100%, rgba(0,26,51,0.4), transparent 50%)' }} />
      ...
      <div className="relative z-10 lg:pl-24 lg:pr-24 pt-20">
        <Outlet />
      </div>
    </div>
  );
